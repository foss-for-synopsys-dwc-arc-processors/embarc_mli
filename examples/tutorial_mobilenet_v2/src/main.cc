...
#define IMAGE_SIDE 96
#define NUM_CHANNELS 3
#define IMAGE_SIZE (IMAGE_SIDE * IMAGE_SIDE * NUM_CHANNELS)
#define EXAMPLES_NUM 5

const char* image_paths[EXAMPLES_NUM] = {"img\\460.jpg", "img\\531.jpg",
                                         "img\\699.jpg", "img\\795.jpg",
                                         "img\\867.jpg"};
...
void loop() {
  reporter->Report("Running MobileNet v2");
...
int main() {
  ...
  // Load Model
  model = tflite::GetModel(mobilenet_v2_tflite);
