...
#ifndef _MLI_KRN_DOTPROD_DEPRECATED_H_
#define _MLI_KRN_DOTPROD_DEPRECATED_H_

#ifdef _MLI_KRN_DOTPROD_DSP_H_
#error "depricated and new version of dotprod cannot be used together"
#endif
...
#endif // _MLI_KRN_DOTPROD_DEPRECATED_H_
