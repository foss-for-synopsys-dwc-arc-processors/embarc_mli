...
mli_status mli_krn_fully_connected_fx8(
    ...
    mli::krn::fully_connected_prepare_and_run<int8_t, int8_t, int8_t, mli_fx8_accu_t, mli::krn::fx_quant_specific_params>(in, weights, bias, cfg, out);
...
mli_status mli_krn_fully_connected_fx8w16d(
    ...
    mli::krn::fully_connected_prepare_and_run<int16_t, int8_t, int8_t, mli_acc32_t, mli::krn::fx_quant_specific_params>(in, weights, bias, cfg, out);
...
mli_status mli_krn_fully_connected_fx16_fx8_fx8(
    ...
    mli::krn::fully_connected_prepare_and_run<int16_t, int8_t, int8_t, mli_fx16_fx8_fx8_accu_t, mli::krn::fx_quant_specific_params>(in, weights, bias, cfg, out);
