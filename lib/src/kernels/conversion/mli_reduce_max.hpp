...
#ifndef _MLI_REDUCE_MAX_HPP_
#define _MLI_REDUCE_MAX_HPP_

#include "mli_reduce_max_decl.hpp"
...
namespace krn {
  ...
  using snps_arc::metaware::mli::krn::ref::mli_reduce_max;
