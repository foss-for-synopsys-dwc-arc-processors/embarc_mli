...
mli_status mli_krn_conv2d_hwcn_fx16(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int16_t, int16_t, int16_t, mli_fx16_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_VAR, KRN_SZ_VAR>
...
mli_status mli_krn_conv2d_hwcn_fx16_fx8_fx8(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int8_t, int16_t, int8_t, mli_fx16_fx8_fx8_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_VAR, KRN_SZ_VAR>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_sa8_sa8_sa32(
    ...
    mli::krn::conv2d_prepare_and_run
            <int8_t, int8_t, int8_t, int32_t, mli_sa8_sa8_sa32_accu_t, mli::krn::s8asym_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_VAR, KRN_SZ_VAR>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_fx16_k1x1(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int16_t, int16_t, int16_t, mli_fx16_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_1, KRN_SZ_1>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_fx16_fx8_fx8_k1x1(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int8_t, int16_t, int8_t, mli_fx16_fx8_fx8_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_1, KRN_SZ_1>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_sa8_sa8_sa32_k1x1(
    ...
    mli::krn::conv2d_prepare_and_run
            <int8_t, int8_t, int8_t, int32_t, mli_sa8_sa8_sa32_accu_t, mli::krn::s8asym_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_1, KRN_SZ_1>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_fx16_k3x3(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int16_t, int16_t, int16_t, mli_fx16_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_3, KRN_SZ_3>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_fx16_fx8_fx8_k3x3(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int8_t, int16_t, int8_t, mli_fx16_fx8_fx8_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_3, KRN_SZ_3>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_sa8_sa8_sa32_k3x3(
    ...
    mli::krn::conv2d_prepare_and_run
            <int8_t, int8_t, int8_t, int32_t, mli_sa8_sa8_sa32_accu_t, mli::krn::s8asym_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_3, KRN_SZ_3>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_fx16_k5x5(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int16_t, int16_t, int16_t, mli_fx16_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_5, KRN_SZ_5>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_fx16_fx8_fx8_k5x5(
    ...
    mli::krn::conv2d_prepare_and_run
            <int16_t, int8_t, int16_t, int8_t, mli_fx16_fx8_fx8_accu_t, mli::krn::fx_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_5, KRN_SZ_5>
            (in, weights, bias, cfg, out);
    return ret;
}
...
mli_status mli_krn_conv2d_hwcn_sa8_sa8_sa32_k5x5(
    ...
    mli::krn::conv2d_prepare_and_run
            <int8_t, int8_t, int8_t, int32_t, mli_sa8_sa8_sa32_accu_t, mli::krn::s8asym_quant_specific_params, LAYOUT_HWCN, mli::CONV_GENERAL, KRN_SZ_5, KRN_SZ_5>
            (in, weights, bias, cfg, out);
    return ret;
}
