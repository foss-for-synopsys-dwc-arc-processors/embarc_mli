...
mli_status mli_krn_depthwise_conv2d_hwc_sa8_sa8_sa32_k3x3_str1_krnpad(
        const mli_tensor * in, 
...
mli_status mli_krn_depthwise_conv2d_hwc_sa8_sa8_sa32_k3x3_str2_krnpad(
        const mli_tensor * in, 
        const mli_tensor * weights, 
        const mli_tensor * bias, 
        const mli_conv2d_cfg * cfg, 
...
mli_status mli_krn_depthwise_conv2d_hwc_sa8_sa8_sa32(
    ...
    if ((stride_w == 2) && (stride_h == 2) && 
        ...
        return mli_krn_depthwise_conv2d_hwc_sa8_sa8_sa32_k3x3_str2_krnpad(in, weights, bias, cfg, out);
    } else if ((stride_w == 1) && (stride_h == 1) && 
            (kernel_w == 3) && (kernel_h == 3) && 
            (padding_top == 1) && (padding_bot == 1) && (padding_left == 1) && (padding_right == 1)) {
        return mli_krn_depthwise_conv2d_hwc_sa8_sa8_sa32_k3x3_str1_krnpad(in, weights, bias, cfg, out);
    } else {
...
char * mli_debug_krn_depthwise_conv2d_hwc_sa8_sa8_sa32(
    ...
    if ((stride_w == 2) && (stride_h == 2) && 
            (kernel_w == 3) && (kernel_h == 3) && 
            (padding_top <= 1) && (padding_bot <= 1) && (padding_left <= 1) && (padding_right <= 1)) {
        return (char*)"mli_krn_depthwise_conv2d_hwc_sa8_sa8_sa32_k3x3_str2_krnpad";
    } else if ((stride_w == 1) && (stride_h == 1) && 
            (kernel_w == 3) && (kernel_h == 3) && 
            (padding_top == 1) && (padding_bot == 1) && (padding_left == 1) && (padding_right == 1)) {
        return (char*)"mli_krn_depthwise_conv2d_hwc_sa8_sa8_sa32_k3x3_str1_krnpad";
    } else {
