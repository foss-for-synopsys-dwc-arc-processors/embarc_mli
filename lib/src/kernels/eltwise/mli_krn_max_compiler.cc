...
mli_status Max_CS::AttachBufferOffsets(const Tensor<OffsetBuffer, kEltwiseRank> &input_left,
...
mli_status Max_CS::AttachBufferOffsets(const OffsetBuffer &input_left,
