...
mli_status mli_krn_avepool_chw_fx8(const mli_tensor * in, const mli_pool_cfg * cfg, mli_tensor * out) {
    ...
    if ((stride_w == 1) && (stride_h == 1) && 
        ...
        return mli_krn_avepool_chw_fx8_k4x4_str1_nopad(in, cfg, out);
    } else if ((stride_w == 1) && (stride_h == 1) && 
            (kernel_w == 2) && (kernel_h == 2) && 
            (padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
        return mli_krn_avepool_chw_fx8_k2x2_str1_nopad(in, cfg, out);
...
char * mli_debug_krn_avepool_chw_fx8(const mli_tensor * in, const mli_pool_cfg * cfg, mli_tensor * out) {
    ...
    if ((stride_w == 1) && (stride_h == 1) && 
            (kernel_w == 4) && (kernel_h == 4) && 
            (padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
        return (char*)"mli_krn_avepool_chw_fx8_k4x4_str1_nopad";
    } else if ((stride_w == 1) && (stride_h == 1) && 
            (kernel_w == 2) && (kernel_h == 2) && 
            (padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
        return (char*)"mli_krn_avepool_chw_fx8_k2x2_str1_nopad";
    } else if ((kernel_w == 9) && (kernel_h == 9) && (padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
