            ...
            if (kernel_w == 9) {
                if (kernel_h == 9) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k9x9_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 4) && (padding_bot == 4) && (padding_left == 4) && (padding_right == 4)) {
                        return mli_krn_avepool_chw_fx8_k9x9_str1_krnpad(in, cfg, out);
                    } else {
                ...
                if (kernel_h == 8) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k8x8_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 3) && (padding_bot == 4) && (padding_left == 3) && (padding_right == 4)) {
                        return mli_krn_avepool_chw_fx8_k8x8_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 6) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k8x6_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 2) && (padding_bot == 3) && (padding_left == 3) && (padding_right == 4)) {
                        return mli_krn_avepool_chw_fx8_k8x6_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 4) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k8x4_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 1) && (padding_bot == 2) && (padding_left == 3) && (padding_right == 4)) {
                        return mli_krn_avepool_chw_fx8_k8x4_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 2) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k8x2_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 0) && (padding_bot == 1) && (padding_left == 3) && (padding_right == 4)) {
                        return mli_krn_avepool_chw_fx8_k8x2_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else {
                ...
                if (kernel_h == 7) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k7x7_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 3) && (padding_bot == 3) && (padding_left == 3) && (padding_right == 3)) {
                        return mli_krn_avepool_chw_fx8_k7x7_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else {
                ...
                if (kernel_h == 8) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k6x8_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 3) && (padding_bot == 4) && (padding_left == 2) && (padding_right == 3)) {
                        return mli_krn_avepool_chw_fx8_k6x8_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 6) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k6x6_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 2) && (padding_bot == 3) && (padding_left == 2) && (padding_right == 3)) {
                        return mli_krn_avepool_chw_fx8_k6x6_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 4) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k6x4_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 1) && (padding_bot == 2) && (padding_left == 2) && (padding_right == 3)) {
                        return mli_krn_avepool_chw_fx8_k6x4_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 2) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k6x2_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 0) && (padding_bot == 1) && (padding_left == 2) && (padding_right == 3)) {
                        return mli_krn_avepool_chw_fx8_k6x2_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else {
                ...
                if (kernel_h == 5) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k5x5_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 2) && (padding_bot == 2) && (padding_left == 2) && (padding_right == 2)) {
                        return mli_krn_avepool_chw_fx8_k5x5_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else {
                ...
                if (kernel_h == 8) {
                    if ((padding_top == 3) && (padding_bot == 4) && (padding_left == 1) && (padding_right == 2)) {
                        return mli_krn_avepool_chw_fx8_k4x8_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 6) {
                    if ((padding_top == 2) && (padding_bot == 3) && (padding_left == 1) && (padding_right == 2)) {
                        return mli_krn_avepool_chw_fx8_k4x6_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 4) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        ...
                        return mli_krn_avepool_chw_fx8_k4x4_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else if (kernel_h == 2) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k4x2_str1_nopad(in, cfg, out);
                    } else if ((padding_top == 0) && (padding_bot == 1) && (padding_left == 1) && (padding_right == 2)) {
                        return mli_krn_avepool_chw_fx8_k4x2_str1_krnpad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else {
                ...
                if (kernel_h == 3) {
                    if ((padding_top == 0) && (padding_bot == 0) && (padding_left == 0) && (padding_right == 0)) {
                        return mli_krn_avepool_chw_fx8_k3x3_str1_nopad(in, cfg, out);
                    } else {
                        return mli_krn_avepool_chw_fx8_generic(in, cfg, out);
                    }
                } else {
