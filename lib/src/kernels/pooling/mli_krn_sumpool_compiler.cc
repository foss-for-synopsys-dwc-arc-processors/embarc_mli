...
mli_status SumPool2D_CS::AttachBufferOffsets(const Tensor<OffsetBuffer, kPoolRank> &input,
...
mli_status SumPool2D_CS::AttachBufferOffsets(const OffsetBuffer &input,
