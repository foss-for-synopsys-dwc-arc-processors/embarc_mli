...
template <>
MLI_FORCE_INLINE vNx2int_t mli_math_cast_fx(vNx2short_t in_val) {
    return to_vNx2int_t(in_val);
}
...
template<>
MLI_FORCE_INLINE vNx2int_t mli_math_acc_cast_fx<vNx2int_t, vNx2accint_t, /*round = */ false>(
