...
static const data_movement_test_operands tests_list[] = {
    {"Test 1 FX16 Copy", mli_mov_tensor_sync, input_1_fx16,
                                        test_1_out_fx16,
                                        thresholds_fx16_general, test_1_chksum_fx16},
    {"Test 1 SA8  Copy AXIS = 1", mli_mov_tensor_sync, input_1_sa8,
                                        test_1_out_sa8,
                                        thresholds_sa8_general, test_1_chksum_sa8},
    {"Test 2 FX16 Copy MemStr", mli_mov_tensor_sync, input_2_fx16,
                                        test_2_out_fx16,
                                        thresholds_fx16_general, test_2_chksum_fx16},
    {"Test 2 SA8 Copy MemStr", mli_mov_tensor_sync, input_2_sa8,
                                        test_2_out_sa8,
                                        thresholds_sa8_general, test_2_chksum_sa8},
    {"Test 3 FX16 Slice MemStr", mli_mov_tensor_sync, input_3_fx16,
                                        test_3_out_fx16,
                                        thresholds_fx16_general, test_3_chksum_fx16},
    {"Test 3 SA8 Slice MemStr", mli_mov_tensor_sync, input_3_sa8,
                                        test_3_out_sa8,
                                        thresholds_sa8_general, test_3_chksum_sa8},
    {"Test 4 FX16 Concat", mli_mov_tensor_sync, input_1_fx16,
                                        test_4_out_fx16,
                                        thresholds_fx16_general, test_4_chksum_fx16},
    {"Test 5 FX16 Padding", mli_mov_tensor_sync, input_3_fx16,
                                        test_5_out_fx16,
                                        thresholds_fx16_general, test_5_chksum_fx16},
    {"Test 5 SA8 Padding", mli_mov_tensor_sync, input_3_sa8,
                                        test_5_out_sa8,
                                        thresholds_sa8_general, test_5_chksum_sa8},
    {"Test 6 FX16 Permute", mli_mov_tensor_sync, input_4_fx16,
                                        test_6_out_fx16,
                                        thresholds_fx16_general, test_6_chksum_fx16},
    {"Test 6 SA8 Permute", mli_mov_tensor_sync, input_4_sa8,
                                        test_6_out_sa8,
                                        thresholds_sa8_general, test_6_chksum_sa8},
    {"Test 7 FX16 Subsample", mli_mov_tensor_sync, input_1_fx16,
                                        test_7_out_fx16,
                                        thresholds_fx16_general, test_7_chksum_fx16},
    //slice and Padding
    {"Test 8 FX16 SlicePadd", mli_mov_tensor_sync, input_3_fx16,
                                        test_8_out_fx16,
                                        thresholds_fx16_general, test_8_chksum_fx16},
    {"Test 8 SA8 SlicePadd", mli_mov_tensor_sync, input_3_sa8,
                                        test_8_out_sa8,
                                        thresholds_sa8_general, test_8_chksum_sa8},
    //Permute and Subsample
    {"Test 9 FX16 PermSubs MemStr", mli_mov_tensor_sync, input_1_fx16,
                                        test_9_out_fx16,
                                        thresholds_fx16_general, test_9_chksum_fx16},
    //Permute and Subsample and Padding
    {"Test 10 FX16 PermSubsPadd", mli_mov_tensor_sync, input_3_fx16,
                                        test_10_out_fx16,
                                        thresholds_fx16_general, test_10_chksum_fx16},
    {"Test 10 SA8 PermSubsPadd", mli_mov_tensor_sync, input_3_sa8,
                                        test_10_out_sa8,
                                        thresholds_sa8_general, test_10_chksum_sa8},
    //slice and Subsample and padding
    {"Test 11 FX16 SlicSubPad", mli_mov_tensor_sync, input_5_fx16,
                                        test_11_out_fx16,
                                        thresholds_fx16_general, test_11_chksum_fx16},
    {"Test 11 SA8 SlicSubPad", mli_mov_tensor_sync, input_5_sa8,
                                        test_11_out_sa8,
                                        thresholds_sa8_general, test_11_chksum_sa8},
    //slice and Subsample and padding with MemStr in inner most dimension
    {"Test 12 FX16 SlicSubPad MemStr", mli_mov_tensor_sync, input_6_fx16,
                                        test_12_out_fx16,
                                        thresholds_fx16_general, test_12_chksum_fx16},
    {"Test 12 SA8 SlicSubPad MemStr", mli_mov_tensor_sync, input_6_sa8,
                                        test_12_out_sa8,
                                        thresholds_sa8_general, test_12_chksum_sa8},
    //slice and Subsample
    {"Test 13 SA32 SlicSubs", mli_mov_tensor_sync, input_7_sa32,
                                        test_13_out_sa32,
                                        thresholds_sa32_general, test_13_chksum_sa32},
    //slice and Subsample and padding with MemStr
    {"Test 14 SA32 SlicSubPad MemStr", mli_mov_tensor_sync, input_8_sa32,
                                        test_14_out_sa32,
